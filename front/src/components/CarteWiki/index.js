                            ...
                            <map name="image-map">
                                ...
                                <Link to="/wiki/kervollen">
                                    <area 
                                        ...
                                        shape="poly"
                                        onMouseOver={() => darkenMap('Kervollen')}
                                        onMouseOut={() => fullView('Kervollen')}  
                                    />
                                </Link>
                                <Link to="/wiki/vanna">
                                    <area 
                                        ...
                                        shape="poly"
                                        onMouseOver={() => darkenMap('Vanna')}
                                        onMouseOut={() => fullView('Vanna')}   
                                    />
                                </Link>   
                                <Link to="/wiki/feidlimid">
                                    <area 
                                        ...
                                        shape="poly"
                                        onMouseOver={() => darkenMap('Feidlimid')}
                                        onMouseOut={() => fullView('Feidlimid')}  
                                    />
                                </Link>
                                <Link to="/wiki/droknor">
                                    <area 
                                        ...
                                        shape="poly"
                                        onMouseOver={() => darkenMap('Droknor')}
                                        onMouseOut={() => fullView('Droknor')}   
                                    />
                                </Link>
                            </map>
                            <img
