-- Deploy radamir:seeding_region_blocks to pg

BEGIN;

INSERT INTO "wiki"
("slug", "title", "full_title", "type")
VALUES
('vanna', 'Vanna', 'Le Domaine de Vanna', 'region'),
('feidlimid', 'Feidlimid', 'Les Bois de Feidlimid', 'region'),
('kervollen', 'Kervollen', 'Le Royaume de Kervollen', 'region'),
('karnaclok', 'Karnaclok', 'L''Empire de Karnaclok', 'region'),
('droknor', 'Drok''nor', 'L''Île de Drok''nor','region'),
('nano', 'NaN0', '', 'general');

INSERT INTO "block"
(
	"title", "content", "wiki_id"
)
VALUES
(
	'Historique',
